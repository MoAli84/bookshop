...
<body>
    ...
    <div class="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="right-nav align-items-center d-flex justify-content-end list-inline"> <a class="btn btn-white btn-sm" href="login.php">Login</a>
                                    <div class="right-nav align-items-center d-flex justify-content-end list-inline"> <a class="btn btn-white btn-sm" href="logout.php">logout</a>
                                        <div class="search">
        ...
        <div class="page-content">
            ...
            on book.type_id = book_type.t_id  where type_id =1";
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="post chil">
                                    ...
                                    <div class="post-image">
                                        <img class="img-fluid h-80 w-80" src="../books/photos/<?php echo $data['images'] ?>" alt="">
                                    </div>
                                    <div class="post-title">
                                        <h5><a href="blog-details.html">Book Name: <?php echo $data['b_name'] ?></a></h5>
                                    </div>
                                    <div class="post-title">
                                        <h5><a href="blog-details.html">Book Author: <?php echo $data['b_author'] ?></a></h5>
                                    </div>
                                    <div class="post-title">
                                        <h5><a href="blog-details.html">Book Publisher: <?php echo $data['publisher'] ?></a></h5>
                                    </div>
                                    <div class="post-title">
                                        <h5><a href="blog-details.html">Classification: <?php echo $data['t_name'] ?></a></h5>
                                    </div>

                                    <p><?php echo substr($data['description'], 0, 200) ?></p>

                                    <div class="post-desc">
                                        <div class="post-date price">Price:<?php echo $data['price'] ?>$
                                        </div>
                                    </div>

                                    <a href='buy.php?id=<?php echo $data['b_id']; ?>' class='btn btn-primary m-r-1em Buy '>Buy</a>
            ...
            <section>
                <div class="container ">
                    <div class="row cont ">
                        ...
                        <?php
                        $sql = "select book.* ,book_type.* from book inner join book_type 
            on book.type_id = book_type.t_id  where type_id =2";
                        $op  = mysqli_query($con, $sql);
            ...
            <section>
                <div class="container ">
                    <div class="row cont ">
                        ...
                        <?php
                        $sql = "select book.* ,book_type.* from book inner join book_type 
            on book.type_id = book_type.t_id  where type_id =4";
                        $op  = mysqli_query($con, $sql);
